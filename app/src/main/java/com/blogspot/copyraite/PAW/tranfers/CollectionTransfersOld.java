...
public class CollectionTransfersOld extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_collection_transfers_old);
...
//        String selectedStatus = statusSpinner.getSelectedItem().toString();
    ...
    private class FetchItemsTask extends AsyncTask<String, Void, List<MyAdapterTransfer.Item>> {
        ...
        protected void onPostExecute(List<MyAdapterTransfer.Item> items) {
            if (items.isEmpty()) {
                Toast.makeText(CollectionTransfersOld.this, "Немає даних для вдіображення", Toast.LENGTH_SHORT).show();
            } else {
